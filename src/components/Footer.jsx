      ...
      <div className="container">
        <div className="footer__inner">
          ...
          <div className="footer__contact">
            ...
            <a href="https://github.com/ernestmpiani" target="_blank" rel="noopener noreferrer" className="footer__link">GitHub →</a>
            <a href="https://linkedin.com/in/ernestmpiani" target="_blank" rel="noopener noreferrer" className="footer__link">LinkedIn →</a>
        ...
        <div className="footer__bottom">
          ...
          <span className="label footer__bottom-right">Built with React + Vite · Deployed on Vercel</span>
        </div>
      </div>
    </footer>
  );
